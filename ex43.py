...
class Death(Scene):
    ...
    def enter(self):
        print "\nYou have decided a foolish choice."
        exit(0)
...
-Use the Christian Armor"""
        ...
        if action == "With bear hands":
            print """\nYou are fast enough to dodge every attacks from the lamia
...
The lamia had defeated you. He gave your body to its babies."""
            ...
            print """\nThe lamia had dodged all the bullets that you had shot.
No more bullets!!!
The lamia had killed you and gave your body to its babies."""
            return 'death'

        elif action == "Use the Christian Armor":
            print """\nEven though, the Armor is inexperienced,
you could defeat the lamia. However, to kill more lamias
you will need the perfect ChristianArmor."""
            return 'LWA'
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print """\nYou have successfully killed the lamia.
However, you need a the perfect Christian Armor.
Lamia had stolen it from Arthur and kept it in the Armory.
Solve the question and get the Armor. You have 5 tries.
The question is:
Divide 20 by 1/2 and add 10."""
        ...
        if guess == answer:
            print """\nYou are correct! There is the perfect holy Christian
Armor of Arthur. Now you can defeat all the lamias."""
            return 'bridge'

        else:
            print """\nThe armory emits poisonous gas
so you suffocate and die."""
            return 'death'
...
class TheBridge(Scene):
    ...
    def enter(self):
        print """\nNow you are carrying your perfect experienced Christian Armor.
So you came to the bridge where there are the most lamias
which are constantly spreading errors to the world.
You need to stop this immediately.
There are total 20 lamias.
Choose the correct action to defeat them."""
...
-Wear the inexperienced Armor"""
        ...
        if action == "Wear the perfect Christian Armor":
            print """\nYou finally wore the perfect Christian Armor from Arthur.
Now you are holy enough to defeat all the lamias from the world.
Thank you for doing a great job."""
            return 'escape'

        elif action == "Wear the inexperienced Armor":
            print """\nYou again wore the inexperienced Armor that you had hard
...
class EscapePod(Scene):
    ...
    def enter(self):
        print """\nYou have to choose the correct pod in order to escape safely.
There are three types:\ngold, silver, and lead.
The gold one said that a man would get what many men desire.
The silver one said that a man would get what he deserved.
The lead one said that a man would have to give and hazard all.
Which one will you choose?"""

        choice = raw_input("> ")

        if choice == "gold":
            print """\nThe outside of this pod looks nice and fancy
but it does not function well.
You have drowned and died."""
            return 'death'

        elif choice == "silver":
            print """\nEven though this one looks tempting, you are a fool.
You will deserve death."""
            return 'death'

        elif choice == "lead":
            print """\nYou had risked your life to save the world.
Great job!
I aprreciate your help to save the world."""
            return 'finish'
...
class Finished(Scene):
    ...
    def enter(self):
        print """\nYou have successfully defeated all the lamias
